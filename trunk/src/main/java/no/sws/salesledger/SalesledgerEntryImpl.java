...
public class SalesledgerEntryImpl implements SalesledgerEntry {
	 ...
	 */
	public SalesledgerEntryImpl(final Integer id, final SalesledgerEntryType entryType, final BigDecimal amount, final Date date) {
	...
	public void setInvoiceUrl(final String url) {
